...
FILTER_MESSAGE_TITLE   = ENV.fetch("FILTER_MESSAGE_TITLE", nil)
...
# === COMMENT UPLOAD CONCURRENCY ===
COMMENT_UPLOAD_THREADS = ENV.fetch('COMMENT_UPLOAD_THREADS', 4).to_i

# === BROWSER TUNING ===
BASECAMP_BROWSER_REDIRECT_TIMEOUT_SECONDS = ENV.fetch('BASECAMP_BROWSER_REDIRECT_TIMEOUT_SECONDS', 5).to_i
